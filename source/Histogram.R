...
Shanghai <- read.csv("https://raw.githubusercontent.com/info201b-au2022/project-lyarrington/main/data/Beijing_PM2.5_2013-2021.csv")
Shenyang <- read.csv("~/Documents/info201/assignments/project-lyarrington/data/Shenyang_PM2.5_2013-2021.csv")
Guangzhou <- read.csv("~/Documents/info201/assignments/project-lyarrington/data/Guangzhou_PM2.5_2013-2021.csv")
Beijing <- read.csv("~/Documents/info201/assignments/project-lyarrington/data/Beijing_PM2.5_2013-2021.csv")
